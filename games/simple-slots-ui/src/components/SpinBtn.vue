...
import { ClientEventName, GameBidFieldsNames } from '@suka-game/simple-slots-shared/src/entrypoint';
...
const handleBid = () => {
    socket.value?.emit(ClientEventName.spin, {
        [GameBidFieldsNames.balanceId]: toHex(bid.value[GameBidFieldsNames.balanceId]),
        [GameBidFieldsNames.currencyAddress]: bid.value[GameBidFieldsNames.currencyAddress],
        [GameBidFieldsNames.currencyNetwork]: bid.value[GameBidFieldsNames.currencyNetwork],
        [GameBidFieldsNames.amount]: toHex(bid.value[GameBidFieldsNames.amount]),
    })
}
</script>
